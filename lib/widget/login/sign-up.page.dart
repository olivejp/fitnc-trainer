          ...
          child: Column(
            ...
            children: <Widget>[
              StorageStreamImageWidget(
                ...
                onSaved: (StorageFile? storagePair) => print(''),
                streamInitialStorageFile: BehaviorSubject<StorageFile>.seeded(StorageFile()),
                onDeleted: (StorageFile? storagePair) => print(''),
              ),
              Card(
                                ...
                                return TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                        ...
                                        suffixIcon: IconButton(
                                            onPressed: () => {
                                                  if (subjPasswordObscure.hasValue) {subjPasswordObscure.sink.add(!subjPasswordObscure.valueOrNull!)}
                                                },
